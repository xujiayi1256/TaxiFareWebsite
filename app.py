...
pickup = st.text_input('Pickup Location',placeholder='Enter your pickup location',value='Madison Square Garden, New York')
if pickup:
...
dropoff = st.text_input('Dropoff Location',placeholder='Enter your dropoff location',value='Trump Tower, New York')
if dropoff:
